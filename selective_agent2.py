...
class SelectiveAgent(Agent):
    ...
    class BehavRequest(CyclicBehaviour):
        ...
        async def on_start(self):
            ...
            self.first_unsubscribe = True
            #self.presence.subscribe("naum3@naumveiga")
            #self.presence.approve("naum3@naumveiga")
        ...
        async def run(self):
            ...
            if msgRequest:
                ...
                if msgRequest.body == "Inscrever" and self.first_subscribe:
                ...
                if msgRequest.body == "Retirar" and self.first_unsubscribe:
                    print("Retirou aqui >>>> ",JID.bare())
                    self.presence.unsubscribe("naum3@naumveiga")
                    self.presence.unsubscribe(str(JID.bare()))
                    self.first_unsubscribe = False
                    self.first_subscribe = True
...
if  __name__ == "__main__":
    seletiveagent = SelectiveAgent("naum6@naumveiga","12345")
    seletiveagent.start()
